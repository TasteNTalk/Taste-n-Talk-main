...
const Navbar = ({ children }) => {
  ...
  const CustomNavLink = ({ to, icon, label }) => {
    ...
    return (
      ...
      >
        <div
          className={`w-8 h-8 flex items-center justify-center rounded-full transition-colors duration-300 shadow-inner ${
            isActive
              ? "bg-[#004a8f] scale-110"
        ...
        >
          <img
            src={icon}
            alt=""
            className={`w-5 h-5 ${isActive ? "filter brightness-110" : ""}`}
          />
        </div>
        <span
  ...
  return (
    <div className="bg-[#022c43] min-h-screen font-serif text-[#e2e4d6] m-0 p-0 box-border">
            ...
            >
              <img
                ...
                className={`rounded-full ${
                  activeButtons.profile ? "filter brightness-110" : ""
                }`}
              />
              {activeButtons.profile && (
                <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-white rounded-full animate-pulse"></span>
      ...
      >
        ...
        >
          <div
            className={`flex items-center justify-center bg-[#004a8f] rounded-l-md shadow-lg transition-all duration-300 border-t border-b border-l border-white/20 group hover:bg-[#0063b8] ${
